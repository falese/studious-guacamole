...
### Publishing
Once the React components have been wired to consume MDX content, files can be pushed to the merged to the main branch of the associated git repo, allowing all the control of code merges and pushes, but for content.  When 
